...
CREATE TABLE departments (
      id DECIMAL(8,2) PRIMARY KEY NOT NULL,
...
CREATE TABLE employees (
      ...
      commission_pct DECIMAL(8,2) DEFAULT NULL,
      manager_id DECIMAL(8,2) NOT NULL,
      PRIMARY KEY(id),
      department_id DECIMAL(8,2),
      	FOREIGN KEY (department_id) REFERENCES departments(id)
);

CREATE TABLE jobs (
      job_id VARCHAR(10) REFERENCES employees(job_id),
...
CREATE TABLE job_history (
      ...
      end_date DATE,
      job_id VARCHAR(10) REFERENCES employees(id),
      department_id DECIMAL(8,2),
      	FOREIGN KEY (department_id) REFERENCES departments(id)
);

CREATE TABLE jobs_grade (
      grade_level VARCHAR(5) NOT NULL PRIMARY KEY,
      lowest_salary INT DEFAULT NULL,
...
INSERT INTO employees (id, first_name, last_name, email, phone_number, hiring_date, job_id, salary, commission_pct, manager_id, department_id) 
